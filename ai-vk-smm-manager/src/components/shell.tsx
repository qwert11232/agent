...
const NAV = [
  ...
  { href: "/posts", label: "Посты", icon: FileText, short: "Посты" },
  { href: "/library", label: "Библиотека фото", icon: Images, short: "Фото" },
  { href: "/insights", label: "Умная аналитика", icon: Brain, short: "AI" },
  { href: "/comments", label: "Комментарии", icon: MessageCircleMore, short: "Комм." },
  { href: "/competitors", label: "Конкуренты", icon: Swords, short: "Vs" },
  { href: "/analytics", label: "Аналитика", icon: BarChart3, short: "Стата" },
  { href: "/chat", label: "Чат с ботом", icon: MessagesSquare, short: "Чат" },
